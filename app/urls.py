...
urlpatterns = [
    ...
    path("machines/clean-sync-all/", views.machines_clean_sync_all, name="machines-clean-sync-all"),
    path("machines/<path:machine_id>/clean-sync/", views.machine_clean_sync, name="machine-clean-sync"),
